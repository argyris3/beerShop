      ...
      <dl className="mt-5 grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="relative overflow-hidden rounded-lg bg-indigo-600 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-200">Today's Sales</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl font-semibold text-gray-200">{stats?.saleToday?.length <= 0 ? '$0.00' : 0}</p>
        ...
        <div className="relative overflow-hidden rounded-lg bg-red-800 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-100">Minimum Order</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl flex items-center font-semibold text-gray-200">
              {' '}
              <BiEuro />
              {statistics[1]}
            </p>
        ...
        <div className="relative overflow-hidden rounded-lg bg-yellow-600 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-200">Maximum Oder</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl flex items-center font-semibold text-gray-200">
              <BiEuro />
        ...
        <div className="relative overflow-hidden rounded-lg bg-green-600 px-4 pt-5 pb-12 shadow sm:px-6 sm:pt-6">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-200">Total Sales</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-6 sm:pb-7">
            <p className="text-2xl flex items-center font-semibold text-gray-100">
              {' '}
              <BiEuro />
              {statistics[2]}
            </p>
