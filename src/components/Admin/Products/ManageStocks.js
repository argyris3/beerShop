                  ...
                  <tbody className="divide-y divide-gray-200 bg-white">
                    ...
                    {products?.map((product) => (
                      <tr key={product._id}>
                        ...
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{product?.totalSold}</td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{product?.qtyLeft}</td>
                        <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{product?.price}.00</td>
                        {/* edit */}
