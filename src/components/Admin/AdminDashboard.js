...
import argy from '../Admin/argy.jpg';
import {
  Bars3CenterLeftIcon,
  BellIcon,
  ClockIcon,
                ...
                <div className="py-6 md:flex md:items-center md:justify-between lg:border-t lg:border-gray-200">
                  <div className="min-w-0 flex-1">
                    ...
                    <div className="flex items-center">
                      <img className="hidden h-16 w-16 rounded-full sm:block" src={argy} alt="argy" />
                      <div>
                        <div className="flex items-center">
                          <img className="h-16 w-16 rounded-full sm:hidden" src={argy} alt="argy" />
