...
import { fetchedCouponAction, updateCouponAction } from '../../../redux/slices/coupons/couponsSlics';
...
export default function UpdateCoupon() {
  ...
  useEffect(() => {
    dispatch(fetchedCouponAction(code));
  }, [dispatch, code]);
  //---Fetch coupon ---
  ...
  return (
    <>
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <h2 className="mt-6 text-center text-3xl font-extrabold text-gray-900">Update Coupon</h2>
      </div>
