...
import { deleteCouponAction, fetchedCouponsAction } from '../../../redux/slices/coupons/couponsSlics';
    ...
    <div className="px-4 sm:px-6 lg:px-8">
      <div className="sm:flex sm:items-center">
        <div className="sm:flex-auto">
          <h1 className="text-xl font-semibold text-gray-900">Manage Coupons - [{coupons?.coupons?.length}]</h1>
          <p className="mt-2 text-sm text-gray-700">List of all coupons in the system</p>
        </div>
                    ...
                    <tbody className="divide-y divide-gray-200 bg-white">
                      {coupons?.coupons?.map((coupon) => (
                        <tr key={coupon._id}>
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">{coupon?.daysLeft}</td>
                          {/* edit icon */}
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-500">
