  ...
  return (
    <>
      <section className="relative overflow-x-hidden">
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full lg:w-2/6 px-4 mb-12 lg:mb-0">
              <div className="py-20 text-center">
                <h3 className="mb-8 text-4xl md:text-5xl font-bold font-heading">Sign Up</h3>
                {/* errr */}
        ...
        <div className="hidden lg:block lg:absolute top-0 bottom-0 right-0 lg:w-3/6 bg-center bg-cover bg-no-repeat">
          <img className="w-full h-full" src={beer} alt="bacillus"></img>
        </div>
      </section>
    </>
  );
