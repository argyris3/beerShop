          ...
          <div className="relative flex flex-wrap bg-white">
            <div className="w-full md:w-4/6 px-4">
              <div className="lg:max-w-3xl mx-auto py-20 px-4 md:px-10 lg:px-20">
                ...
                <p className="mb-10 font-semibold text-2xl font-heading">Welcome Back..</p>
                {/* error */}
            ...
            <div className="w-full md:w-2/6 h-128 md:h-auto flex items-center lg:items-end px-4 pb-20 bg-cover bg-no-repeat">
              <img src={beer} alt="bacillus"></img>
            </div>
          </div>
        </div>
      </section>
