...
//fetched coupons
export const fetchedCouponsAction = createAsyncThunk(
  'coupons/fetch All',
...
//fetch coupon
export const fetchedCouponAction = createAsyncThunk(
  'coupons/single',
...
const couponsSlice = createSlice({
  ...
  extraReducers: (builder) => {
    ...
    //fetch all
    builder.addCase(fetchedCouponsAction.pending, (state) => {
      state.loading = true;
    });
    builder.addCase(fetchedCouponsAction.fulfilled, (state, action) => {
      state.loading = false;
      state.coupons = action.payload;
    });
    builder.addCase(fetchedCouponsAction.rejected, (state, action) => {
      state.loading = false;
      state.coupons = null;
      state.error = action.payload;
    });
    //fetch single
    builder.addCase(fetchedCouponAction.pending, (state) => {
      state.loading = true;
    });
    builder.addCase(fetchedCouponAction.fulfilled, (state, action) => {
      state.loading = false;
      state.coupon = action.payload;
    });
    builder.addCase(fetchedCouponAction.rejected, (state, action) => {
      state.loading = false;
      state.coupon = null;
